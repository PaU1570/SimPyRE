...
class ScenarioModel(BaseModel):
    ...
    scenario_years: int
    stock_returns: list[float]  # Annual returns for stocks, as percentages (e.g., 0.07 for 7%)
    bond_returns: list[float]   # Annual returns for bonds, as percentages (e.g., 0.03 for 3%)
    inflation_rates: list[float]  # Annual inflation rates, as percentages (e.g., 0.02 for 2%)
